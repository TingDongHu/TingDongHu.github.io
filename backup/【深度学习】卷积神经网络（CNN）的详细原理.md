...
连续形式：
![Image](https://github.com/user-attachments/assets/c833ade1-0d3c-404f-a034-449a1456c35c)
离散形式：
![Image](https://github.com/user-attachments/assets/9d325b9e-f888-4d25-b519-bb092177286b)
...
![Image](https://github.com/user-attachments/assets/3e9d26db-c52c-4cb3-81cf-e14f45f03fa3)
![Image](https://github.com/user-attachments/assets/e8c505f3-4d5b-477a-8a75-50f39693c292)
...
![Image](https://github.com/user-attachments/assets/9244c2f3-3655-4a3a-a659-f121ac5a9b55)
### 为什么要学习卷积神经网络？
在传统神经网络中，我们要识别下图红色框中的图像时，我们很可能识别不出来，因为这六张图中同一形状的位置都不通，计算机无法分辨出他们其实是一种形状或物体。

![Image](https://github.com/user-attachments/assets/2c21fe66-86c2-4766-825d-55e482b0ba0a)
 传统神经网络原理如下图：
![Image](https://github.com/user-attachments/assets/bf1f9c3f-2bc6-4874-bf7c-8cceda9c7751)
我们希望一个物体不管在画面左侧还是右侧，都会被识别为同一物体，这一特点就是不变性。为了实现平移不变性，卷积神经网络（CNN）等深度学习模型在卷积层中使用了卷积操作，这个操作可以捕捉到图像中的局部特征而不受其位置的影响。

![Image](https://github.com/user-attachments/assets/7fabd9d0-b616-488d-bc18-da4990c07e55)
### 图片的卷积是怎样计算的？
...
![Image](https://github.com/user-attachments/assets/e53dcf28-5427-42b6-93cf-640d5abf041a)
#### 卷积计算中的一些关键参数
- 步长stride：每次滑动的位置步长。
...
### 卷积神经网络的模型是什么样的？
![Image](https://github.com/user-attachments/assets/bf458509-39f2-4da5-a3ec-a3c1a39129c9)
上面红框框起来的部分便可以理解为一个滤波器，即带着一组固定权重的神经元。多个滤波器叠加便成了卷积层。
### 卷积神经网络的构造
![Image](https://github.com/user-attachments/assets/ab209dc0-080b-40ea-ba6e-a6fc78617202)
...
![Image](https://github.com/user-attachments/assets/0a66a9fa-ba28-4c5e-a2ca-f5ded84d95d1)

图片卷积后的样子

![Image](https://github.com/user-attachments/assets/e40cc033-ac3a-41b2-a69c-2cad912d2653)