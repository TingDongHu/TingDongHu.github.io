...
![image-20250722165200809](image-20250722165200809.png)
...
![image-20251128200825154](image-20251128200825154.png)
...
![image-20251128201234821](image-20251128201234821.png)

### 最近邻采样（Nearest Neighbor Sampling）

![image-20251128201817529](image-20251128201817529.png)
...
![image-20251129010504959](image-20251129010504959.png)
...
![image-20251129010822835](image-20251129010822835.png)

以512个小像素为例，得到的结果如下图

![image-20251129010840417](image-20251129010840417.png)
...
![image-20251129011638283](image-20251129011638283.png)

> [!IMPORTANT]
>
> 因为生成了多个较小的图像，需要额外储存生成的小图像，Mipmap方法算是一个经典的空间换时间策略。在某些教材表述中，该方法也被称为“纹理金字塔”(Texture Pyramid)。

![image-20251129012121646](image-20251129012121646.png)
...
![image-20251129013145735](image-20251129013145735.png)

这时候我们再延续之前的插值思想，把离散变为连续，在层与层之间进行插值，这个方法就是**三线性插值**。

![image-20251129013405597](image-20251129013405597.png)
...
![image-20251129013517085](image-20251129013517085.png)

在经历了插值后，可以看到，衔接处的割裂情况少了很多，过渡更加平滑。

### 各向异性过滤Anisotropic Filtering

![image-20251129014324864](image-20251129014324864.png)
...
![image-20251129014903467](image-20251129014903467.png)
...
![image-20251129020204129](image-20251129020204129.png)
...
![image-20251129020550873](image-20251129020550873.png)
...
![image-20251129201700456](image-20251129201700456.png)
...
![image-20251129202107492](image-20251129202107492.png)
...
![image-20251129202841641](image-20251129202841641.png)

这种技术广泛应用于游戏和电影中，以减少模型的多边形数量，同时增加视觉细节。

![image-20251129203352163](image-20251129203352163.png)
...
![image-20251129203114986](image-20251129203114986.png)

此外对于复杂模型的环境光照，也可以预先计算好存储在纹理中：

![image-20251129204156754](image-20251129204156754.png)

纹理还不止于3D物体表面，也可以用于存储空间结构，比如3D模型内部的密度，医学中使用3D纹理直接进行体积渲染

![image-20251129204325334](image-20251129204325334.png)