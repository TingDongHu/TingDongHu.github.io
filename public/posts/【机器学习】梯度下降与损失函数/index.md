...
![Gradient-Descent（全世界最通俗易懂的梯度下降法详解-优化函数大法）](v2-6d78a2ab1092a44151213358e805bace_1440w.png)

关于梯度的引入，可以分为四个概念：导数->偏导->方向导数->梯度
***导数***：当函数定义域和取值都在实数域中时，导数可以表示函数曲线上的切线斜率。

![经典的导数与微分示意图](20160325131532476.png)
...
![这里写图片描述](70-1745567158159-8.jpeg)
...
![在这里插入图片描述](33de3c37c721bf09cdaa69b975232141.png)
...
![在这里插入图片描述](bcbc31590b6a36406a3f68b3184127cc.jpeg)
