...
![3D生成四大范式对比](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/01-comparison-generation-paradigms.png)
...
![NeRF体渲染原理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/02-infographic-nerf-volumetric-rendering.png)
...
![SDS优化流程](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/03-flowchart-sds-optimization.png)
...
![两阶段策略框架](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/06-framework-two-stage-strategy.png)
...
![SDS与VSD对比](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/04-comparison-sds-vs-vsd.png)
...
![3DGS生成原理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/05-infographic-3dgs-generation.png)
...
![前馈模型与优化模型对比](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part3-core-generative-models/07-comparison-feedforward-vs-optimization.png)
...
[1] Wu, J., et al. "3D-GAN: Learning a Probabilistic Latent Space of Object Shapes via 3D Generative-Adversarial Modeling." NeurIPS 2016.

[2] Tatarchenko, M., et al. "Octree Generating Networks: Efficient Convolutional Architectures for High-resolution 3D Outputs." CVPR 2017.

[3] Yang, G., et al. "PointFlow: 3D Point Cloud Generation with Continuous Normalizing Flows." ICCV 2019.

[4] Cai, R., et al. "Learning Gradient Fields for Shape Generation." ECCV 2020.

[5] Nichol, A., et al. "Point-E: A System for Generating 3D Point Clouds from Complex Prompts." 2022.

[6] Liu, R., et al. "Zero-1-to-3: Zero-shot One Image to 3D Object." CVPR 2023.

[7] Mildenhall, B., et al. "NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis." ECCV 2020.

[8] Poole, B., et al. "DreamFusion: Text-to-3D using 2D Diffusion." ICLR 2023.

[9] Lin, C.H., et al. "Magic3D: High-Resolution Text-to-3D Content Creation." CVPR 2023.

[10] Wang, Z., et al. "ProlificDreamer: High-Fidelity and Diverse Text-to-3D Generation with Variational Score Distillation." NeurIPS 2023.

[11] Shi, Y., et al. "MVDream: Multi-View Diffusion for 3D Generation." ICLR 2024.

[12] Chen, R., et al. "Fantasia3D: Disentangling Geometry and Appearance for High-quality Text-to-3D Content Creation." ICCV 2023.

[13] Kerbl, B., et al. "3D Gaussian Splatting for Real-Time Radiance Field Rendering." SIGGRAPH 2023.

[14] Chen, W., et al. "DIB-R: Learning to Relight and Dress for Portrait Manipulation." NeurIPS 2019.

[15] Gao, J., et al. "GET3D: A Generative Model of High Quality 3D Textured Shapes Learned from Images." NeurIPS 2022.

[16] Laine, S., et al. "Modular Primitives for High-Performance Differentiable Rendering." SIGGRAPH Asia 2020.

[17] Jun, H., & Nichol, A. "Shap-E: Generating Conditional 3D Implicit Functions." 2023.

[18] Hong, Y., et al. "LRM: Large Reconstruction Model for Single Image to 3D." 2023.

[19] Xu, J., et al. "InstantMesh: Efficient 3D Mesh Generation from a Single Image with Sparse-view Large Reconstruction Models." 2024.

[20] Tochilkin, D., et al. "TripoSR: Fast 3D Object Reconstruction from a Single Image." 2024.

[21] Ren, X., et al. "XCube: Large-Scale 3D Generative Modeling using Sparse Voxel Hierarchies." 2024.

[22] Song, J., et al. "Denoising Diffusion Implicit Models." ICLR 2021.

## 扩展阅读

- Rombach, R., et al. "High-Resolution Image Synthesis with Latent Diffusion Models." CVPR 2022. — Stable Diffusion 基础论文
- Radford, A., et al. "Learning Transferable Visual Models From Natural Language Supervision." ICML 2021. — CLIP 模型
- [threestudio](https://github.com/threestudio-project/threestudio) — 文本到3D的统一框架
- [nerfstudio](https://docs.nerf.studio) — NeRF 训练与部署框架
