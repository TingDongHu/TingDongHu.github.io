...
![评估维度框架](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/01-framework-evaluation-dimensions.png)

客观指标是评估体系的主体，但其设计、计算与解释均蕴含深刻的统计与几何假设。忽视这些假设将导致系统性的评估偏差。

### 5.2.1 几何质量指标

![几何评估指标](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/02-infographic-geometric-metrics.png)
...
![视觉评估指标](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/03-infographic-visual-metrics.png)
...
![语义对齐评估](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/05-infographic-semantic-alignment.png)
...
![指标冲突分析](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/04-infographic-metric-conflicts.png)
...
![功能性验证流程](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part5-evaluation-validation/06-flowchart-functional-validation.png)
...
[1] Heusel, M., et al. "GANs Trained by a Two Time-Scale Update Rule Converge to a Local Nash Equilibrium." NeurIPS 2017. — FID 指标

[2] Zhang, R., et al. "The Unreasonable Effectiveness of Deep Features as a Perceptual Metric." CVPR 2018. — LPIPS 指标

[3] Wang, Z., et al. "Image Quality Assessment: From Error Visibility to Structural Similarity." IEEE TIP 2004. — SSIM 指标

[4] Radford, A., et al. "Learning Transferable Visual Models From Natural Language Supervision." ICML 2021. — CLIP Score

[5] Rubenstein, P., et al. "The Earth Mover's Distance as a Metric for Image Retrieval." IJCV 2000. — EMD 指标

[6] Achlioptas, P., et al. "Learning Representations and Generative Models for 3D Point Clouds." ICML 2018. — MMD/CD 指标

[7] Tatarchenko, M., et al. "What Do Single-view 3D Reconstruction Networks Learn?" CVPR 2019.

## 扩展阅读

- He, K., et al. "Deep Residual Learning for Image Recognition." CVPR 2016. — 用于特征提取的 backbone
- [Objaverse](https://objaverse.allenai.org) — 大规模3D数据集
