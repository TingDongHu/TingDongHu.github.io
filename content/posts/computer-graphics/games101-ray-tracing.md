...
mathjax: true
categories: ["计算机图形学"]
tags: ["计算机图形学", "图形学", "games101", "光线追踪", "渲染"]
...
![image-20251204170440998](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204170440998.png)
...
![图片7](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/%E5%9B%BE%E7%89%877-1764840093756-2.png)

### **算法流程：经典的“两步走” (2-Pass)**

Shadow Mapping 之所以叫 Mapping，就是因为它需要生成一张图（Map）。整个过程分为两次渲染：

![图片8](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/%E5%9B%BE%E7%89%878.png)
...
![图片9](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/%E5%9B%BE%E7%89%879.png)
...
![image-20251204174328014](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204174328014.png)
...
![image-20251204180531767](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204180531767.png)
...
![image-20251204180738637](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204180738637-1764842864287-6.png)
...
![image-20251204181604681](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204181604681.png)
...
![image-20251204182834879](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204182834879.png)
...
![image-20251204182553871](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251204182553871.png)
...
![image-20251205004556047](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251205004556047.png)

**3. 显式表面求交 (Triangle Mesh)**

这是图形学中最重要的情况，因为绝大多数模型（如牛、建筑、角色）都是由**三角形**组成的 

![image-20251205011756248](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251205011756248.png)
...
![image-20251205011822013](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251205011822013.png)
...
![image-20251205011843923](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251205011843923.png)
...
![image-20251205011928377](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251205011928377.png)
...
![image-20251206203829092](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251206203829092-1765024714727-1.png)

在预处理阶段，找到场景的包围盒，将其划分为分辨率相同的、规则的网格单元（Cells）。每个单元格内存储了与该单元格重叠的物体引用。光线追踪时，光线按照 3D DDA 算法（类似画直线的算法）依序遍历其穿过的网格 。

![image-20251206203154279](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251206203154279.png)

如果场景里的物体分布很均匀（比如这满屏幕的草地），这招快得飞起 。

![image-20251206203439087](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251206203439087.png)
...
![image-20251206205340720](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251206205340720.png)
...
![image-20251206212037335](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251206212037335-1765027242043-3.png)
...
![image-20251207003423239](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光线追踪ray-tracing/image-20251207003423239.png)
