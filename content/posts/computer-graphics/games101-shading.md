...
![光线与着色点](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703000938953.png)
...
![三种不同的Shading类型](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703000605878.png)
...
![漫反射](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703001945326.png)

漫反射的光线均匀地向所有方向散射，从任何视角观察，表面颜色都保持一致。

![漫反射与光线吸收](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703002433178.png)
...
![光线能量衰减](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703002705012.png)
...
![不同Kd的着色效果](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703172641211.png)

上图可以看到，点光源在左上角处，随着Kd越来越大，左上角的物体表面反射光能量越来越多，而右下角处于背光处，所以完全没有光，越往中间部分，法线方向与光照方向的夹角越来越大，所以接收的光能量越来越少，符合 Blinn-Phong 模型。

### 高光与镜面反射

![镜面反射](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703172234525.png)

反射的强度一般取决于观察的方向，一般在镜面反射方向附近最为明亮。高光的产生：**在物体表面的观察角度与光源角度正好是镜面对称时，即可看到高光**

![生活中的镜面](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703172351135.png)

抽象到计算机图形学中，可通过计算镜面反射方向 **R** 与观察方向 **V** 的接近程度来量化高光强度，然而直接计算反射向量 **R** 的运算量较大。Blinn-Phong 光照模型为此引入**半程向量** 来简化计算。

![半程向量计算](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703184829817.png)
...
![p对cosa的衰减影响](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703194136265.png)

从如下图所示的参数影响上看，**Kₛ** 增大，整体高光亮度增强；**p** 增大，高光区域则明显缩小，更集中于反射方向周围。

![Ks与p对着色的影响](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703194344316.png)
...
![环境光照](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703194621009.png)
...
![Blinn-Phong模型](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703194952519.png)
...
![不同着色方法](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703195704918.png)
...
![Flat shading](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703200225281.png)
...
![Gouraud Shading](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703202145746.png)
...
![Phong Shading](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703202956015.png)
...
![三种着色方法应用对比](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703203343008.png)
...
![注定点的法线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703203932707.png)
...
![图形管线示意](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101着色基础/image-20250703210212910.png)
