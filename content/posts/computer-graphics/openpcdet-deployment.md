...
```
查看运行结果
![在这里插入图片描述](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/4b241aa925cb4de2a1df63d6d1271ec4.png)
...
#### 下载安装OpenPCDet 
![image](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/d7ddc3835b204c3a98ebdeb7dfbf05a9.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/7db24f005b9843058674aec5496ccab0.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/a3b0285a62764898b9838bae9a75aefd.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/f147292369fa436a98053030262de736.png)
![image](https://i-blog.csdnimg.cn/direct/1068d6ebe1e34ef0b66ed93ad7c5c489.png)

将数据导入为以下格式

![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/78b11b57b7cb432a9821b01aeb938020.png)
...
```
生成了以下配置文件
![image](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/50b2c6bb94e244368e534b65766cb54c.png)
...
则在以上两个文件中修改内容
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/0b70c6ebf4f243368005339d140175ef.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/08d5b66d18b44956ae5d188299dcd75d.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/30e18827e52c4d08a4030058259cbffd.png)

可以在训练日志train 2024xxxxxxxx.log中查看本次模型的训练精度
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/8530607fb43a42aeac9c5c8b5781f3e9.png)
...
```
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/94b75f6425a345d397eb102ac1ad02c6.png)
...
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dcomputervison/openpcdet详细部署与复现/d75379f4d757425499dea08f5aa9918d.png)
