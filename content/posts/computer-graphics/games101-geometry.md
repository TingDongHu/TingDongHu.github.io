...
mathjax: true
categories: ["计算机图形学"]
tags: ["计算机图形学", "图形学", "games101", "几何", "Blend"]
...
![一些几何学应用](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140412366.png)
...
![代数曲面](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140426016.png)
...
![水平集](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140443215.png)
...
![距离函数与融合](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140450659.png)
...
![点云绘制的罗马角斗场](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140500066.png)

点云表示物体的表面通过一组离散的点来表示。每个点有自己的三维坐标，所有这些点共同描述了物体的形状。点云通常用于通过3D扫描（如激光扫描）获取的实际物体模型，或者在某些特定的计算机视觉应用中（如表面重建）。

**多边形网格（Polygon Mesh）**

![多边形网格](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140508951.png)
...
![三角形和四边形表示的物体](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140516399.png)
...
![Bezier绘制的运动轨迹路径](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140523433.png)
...
![三次Bezier曲线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140530353.png)

这四个点共同决定了曲线的形状。Bezier 曲线的一个显著特性是，曲线始终在由这些控制点构成的凸包内部，这保证了曲线的形状可控。

**de Casteljau 算法：计算 Bézier 曲线**

![DeCasteljau算法](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140537375.png)
...
![递归插值的过程](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140545928.png)
...
![Bezier曲线的几何性质](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140552902.png)
...
![分段Bezier曲线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140559687.png)
...
![双三次Bezier曲面](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140605684.png)
...
![递归插值计算](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251203140611158.png)
...
![Catmull-Clark细分和Loop细分](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130000407988.png)
...
![Loop细分示意](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130000429482.png)
...
![步骤1：细分三角形](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130000522716.png)

- **步骤 2：更新顶点位置**
   更新新顶点的位置时，原始顶点和新顶点的位置是通过不同的加权系数来计算的。新顶点的更新通常基于周围邻域的顶点的加权平均位置。

![加权计算顶点位置](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130000553759.png)
...
![处理旧顶点](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130000619475.png)
...
![找奇异点和规则细分](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/%E5%9B%BE%E7%89%876.png)
...
![Loop算法的特征丢失](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130005346760.png)
...
![网格简化](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130012222427.png)
...
![边坍缩方法](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130012344155.png)
...
![计算几何误差](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130012406528.png)
...
![边坍缩方法的效果](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130012447069.png)
...
![网格正则化](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101几何表达与绘制/image-20251130013042023.png)
