...
![3D生成AI生态系统全景](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part6-practice-frontier-trends/01-framework-ecosystem-map.png)
...
![nerfstudio架构](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part6-practice-frontier-trends/02-infographic-nerfstudio-architecture.png)
...
![threestudio管线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part6-practice-frontier-trends/03-infographic-threestudio-pipeline.png)
...
![学习路径图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part6-practice-frontier-trends/04-flowchart-learning-path.png)
...
![3D生成AI演进时间线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/3dgenai/part6-practice-frontier-trends/05-timeline-3d-genai-evolution.png)
...
[1] Deitke, M., et al. "Objaverse: A Universe of Annotated 3D Objects." CVPR 2023.

[2] Deitke, M., et al. "Objaverse-XL: A Universe of 10M+ 3D Objects." NeurIPS 2023.

[3] Xue, L., et al. "ULIP: Learning a Unified Representation of Language, Images, and Point Clouds for 3D Understanding." CVPR 2023.

[4] Hong, Y., et al. "LRM: Large Reconstruction Model for Single Image to 3D." 2023.

[5] Teytaud, O., et al. "Scaling Laws in 3D Generative Models." 2024.

## 扩展阅读

- [Kaolin](https://github.com/NVIDIAGameWorks/kaolin) — NVIDIA 3D 深度学习库
- [PyTorch3D](https://pytorch3d.org) — Meta 3D 深度学习库
- [threestudio](https://github.com/threestudio-project/threestudio) — 文本到3D统一框架
- [nerfstudio](https://docs.nerf.studio) — NeRF 训练部署框架
- [Hugging Face Diffusers](https://huggingface.co/docs/diffusers) — 扩散模型工具库
- Munkberg, J., et al. "Extracting Triangular 3D Models, Materials, and Lighting From Images." CVPR 2022. — nvdiffrec
