...
mathjax: true
categories: ["计算机图形学"]
tags: ["计算机图形学", "图形学", "games101", "纹理", "渲染"]
...
![包含了多种反射的示例](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251128185121557.png)

## 纹理映射（Texture Mapping）

纹理映射是一种将二维纹理图像（通常为位图）“贴”到三维模型表面的方法，目的是在不增加几何体复杂度的前提下，为三维物体提供更细致的视觉效果。通过纹理映射，物体表面可以拥有丰富的颜色、图案、细节等信息，而不需要额外的多边形面片。

![地球仪表面展开](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20250722165716060.png)
...
![UV坐标与展开](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20250722165200809.png)
...
![三角形重心计算](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/%E5%9B%BE%E7%89%871.png)
...
![重心插值](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251128200825154.png)
...
![纹理放大模糊问题](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251128201234821.png)

### 最近邻采样（Nearest Neighbor Sampling）

![最近邻采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251128201817529.png)
...
![双线性插值](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/%E5%9B%BE%E7%89%872.png)
...
![纹理缩小失真与摩尔纹](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129010504959.png)
...
![超采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129010822835.png)

以512个小像素为例，得到的结果如下图

![超采样结果](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129010840417.png)
...
![Mipmap](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129011638283.png)

> [!IMPORTANT]
>
> 因为生成了多个较小的图像，需要额外储存生成的小图像，Mipmap方法算是一个经典的空间换时间策略。在某些教材表述中，该方法也被称为“纹理金字塔”(Texture Pyramid)。

![纹理金字塔](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129012121646.png)
...
![深度远近区分](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129013145735.png)

这时候我们再延续之前的插值思想，把离散变为连续，在层与层之间进行插值，这个方法就是**三线性插值**。

![三线性插值](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129013405597.png)
...
![多Mipmap平滑过渡](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129013517085.png)

在经历了插值后，可以看到，衔接处的割裂情况少了很多，过渡更加平滑。

### 各向异性过滤Anisotropic Filtering

![各向异性](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129014324864.png)
...
![不同区域的实际映射的真实纹理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129014903467.png)
...
![Ripmap](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129020204129.png)
...
![EWS过滤](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129020550873.png)
...
![环境光贴图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129201700456.png)
...
![环境光照](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202107492.png)
...
![球形纹理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202143455.png)

然而，球形环境图也存在一个**失真问题**，尤其是在图像的顶部和底部区域。这个问题通常在将环境图应用到物体表面时被放大，导致图像的边缘部分产生畸变。

![畸变问题](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202201826.png)

### 立方体映射 (Cube Map)

为了避免球形映射的失真问题，**立方体映射**应运而生。立方体映射通过将环境信息映射到立方体的六个面上，从而减少了球形映射的失真问题。每个面都使用一个正方形的纹理，从而实现更高质量的反射效果。

![立方体映射](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202227141.png)

立方体映射的好处在于，它能够保持更少的失真，并且由于每个面的纹理是正方形，能够更加精确地表达环境光照的信息。与此同时，立方体映射需要对方向向量与立方体面的对应关系进行计算。

![立方体纹理展开](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202312638.png)
...
![橘子表面](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129202841641.png)

这种技术广泛应用于游戏和电影中，以减少模型的多边形数量，同时增加视觉细节。

![凹凸纹理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129203352163.png)
...
![法线计算示意](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/%E5%9B%BE%E7%89%873.png)
...
![位移映射](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129203114986.png)

此外对于复杂模型的环境光照，也可以预先计算好存储在纹理中：

![带有环境光照的人表面纹理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129204156754.png)

纹理还不止于3D物体表面，也可以用于存储空间结构，比如3D模型内部的密度，医学中使用3D纹理直接进行体积渲染

![3D内部纹理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101纹理映射与着色/image-20251129204325334.png)