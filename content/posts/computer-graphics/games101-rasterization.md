...
![光栅化转化为像素点](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629184634259.png)

## 显示器模型

图形学中，屏幕就认为是一个装了像素的二维数组。如数组大小1920*1080，每个数组为一个像素点，像素是最小单位，每个像素由RBG的四维矩阵构成。

![显示器简化模型](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629215327416.png)
...
![透视投影变换](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629212820029.png)



![投影到光栅化](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629213448324.png)
...
![阴极射线管](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629214336936.png)
...
![液晶显示器原理](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629214527981.png)
...
![OLED屏幕](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629214814588.png)
...
![E-INK屏幕](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629214831130.png)
...
![绘制的基本单位](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629214939844.png)
...
![三角形到屏幕像素点](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629184634259.png)
...
![简单近似采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629232243014.png)
...
![采样得到的像素点](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629233550066.png)
...
![BoundingBox对三角形所在Box进行采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629233103291.png)

知道三角形三个顶点的坐标，有了Xmin，Ymin，Xmax，Ymax就可以得到蓝色的区域，只要遍历蓝色区域就可以进行相同的绘制效果。

**Incremental Triangle Traversal**

![Incremental Triangle Traversal](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629233233703.png)

也可以通过一些计算方法，直接从三角形的边上开始一行一行扫描，这个方法更快，但是如何计算出三角形的边缘像素块需要一些特殊处理。

# 采样造成的问题

![采样问题](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629233550066.png)
...
![时间维度采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629233956368.png)

但是采样会造成诸多问题，我们将其称为“Sampling Artifacts  ”(Errors / Mistakes / Inaccuracies in  Computer Graphics)

比较典型的几种问题如锯齿化、摩尔纹、车轮效应等

![采样造成的问题](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629234635227.png)
...
![傅里叶级数和傅里叶变换](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629235701516.png)
...
![傅里叶变换](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629235717230.png)

举个栗子：

![高频信号和低频信号的采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629235757678.png)
...
![采样频率远低于型号变化频率](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250629235930135.png)
...
![滤波](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630000335539.png)
...
![高频通过滤波](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630000643650.png)
...
![低通滤波](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630000900504.png)
...
![卷积的概念](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630001521098.png)

如上图所示，一个三维的卷积核在输入信号上滑动，在每个位置与局部区域进行加权求和，从而生成一个新的、通常略被“压缩”的信号。

#### 卷积的一些定理

![卷积对图像和滤波的影响](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630001832726.png)
...
![时域和频域的采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630002402199.png)
...
![密集采样和稀疏采样](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630003000643.png)
...
![边缘模糊](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630003307623.png)

![image-20250630003320600](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630003320600.png)
...
![基于覆盖率的灰度特调](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630005516069.png)
...
![其实就是上面的边缘模糊](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250630011409945.png)
...
![画家算法](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250701170742411.png)
...
![完全互相重叠问题](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250701170901629.png)
...
![帧缓冲和深度缓冲](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250701172144179.png)
...
![image-20250701172223034](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/games101笔记/games101光栅化基础/image-20250701172223034.png)
