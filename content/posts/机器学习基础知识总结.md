...
![img](机器学习基础知识总结/v2-965f93329490cf628da6d83a092be774_720w.png)
...
![img](机器学习基础知识总结/v2-24062eed3f53d05f4c25df8104541a9a_720w.png)
...
![img](机器学习基础知识总结/v2-c98de3fcdc89af63b295c96603ebac6a_720w.png)
...
![img](机器学习基础知识总结/v2-74061ef82bb018b5c947dfa1815c1861_720w.png)

 所以此时需要这样的形状的模型会比较好 

![img](机器学习基础知识总结/v2-af0dd22c0624b01c05c36cd5c88df600_720w.png)

 那么怎么得到这样的模型呢？ 这个模型需要满足两个条件 大于等于0，小于等于1 大于等于0 的模型可以选择 绝对值，平方值，这里用 指数函数，一定大于0 小于等于1 用除法，分子是自己，分母是自身加上1，那一定是小于1的了

![img](机器学习基础知识总结/v2-3a1b19a81d1144dd05d11067d397318b_720w.png)

 再做一下变形，就得到了 logistic regression 模型

![img](机器学习基础知识总结/v2-90f32cd91c0001557593400b7a0b05b0_720w.png)

 通过源数据计算可以得到相应的系数了

![img](机器学习基础知识总结/v2-300ad4b243074eced044255467b8f1dc_720w.png)

 最后得到 logistic 的图形

![img](机器学习基础知识总结/v2-9bb35a4e6104b5a7c08cc24e787328d4_720w.png)
...
![img](机器学习基础知识总结/v2-98875d691615e53e8229525f0b9963c0_720w.png)

### 3. 分类回归树（决策树）

简单说就是：根据一些 feature 进行分类，每个节点提一个问题，通过判断，将数据分为两类，再继续提问。这些问题是根据已有数据学习出来的，再投入新数据的时候，就可以根据这棵树上的问题，将数据划分到合适的叶子上。

![img](机器学习基础知识总结/v2-8498b810c978640b0a56bc3f59f46cd5_720w.png)
...
![img](机器学习基础知识总结/v2-d02c61a2a757a3bb6d6399c8ae8cebc8_720w.png)
...
![img](机器学习基础知识总结/v2-649615a10cf9fab6619dd3387256792e_720w.png)
...
![img](机器学习基础知识总结/v2-0b68654630cb7a8bca75e1baa41eab8e_720w.png)

如图，当天气是晴天的时候（第一列第一行），选手的状态是如何的呢？

在给定变量天气是晴天（sunny）的时候，为了判断选手的状态是‘yes’还是‘no’，计算概率，然后选择概率更高的作为输出。

![img](机器学习基础知识总结/v2-05a6e9dafa70f9ebc8e2be9b86a7e338_720w.png)
...
![img](机器学习基础知识总结/v2-2220c2d17318955b7500f5413145fa6b_720w.png)



k＝3时，这三条线链接的点就是最近的三个点，那么圆形多一些，所以这个star就是属于猫

![img](机器学习基础知识总结/v2-9bda10affbdafd0233a870a048f3da84_720w.png)
...
![img](机器学习基础知识总结/v2-66e77bd57ba6481825e649acce609d18_720w.png)



将这个超平面表示成一个线性方程，在线上方的一类，都大于等于1，另一类小于等于－1

![img](机器学习基础知识总结/v2-dc3c0b1942c5dd27a1c36937e4113588_720w.png)
...
![img](机器学习基础知识总结/v2-745ec68a0d8bf0f3df9b9c1bccc9c800_720w.png)
...
![img](机器学习基础知识总结/v2-f3962bd8e45308397f540b625ea84e84_720w.png)



![img](机器学习基础知识总结/v2-854b4e49463ee2e20654f345f84f6990_720w.png)

分好类后，计算每一类的平均值，作为新一轮的中心点

![img](机器学习基础知识总结/v2-7773a83b380b52990d1927cbd5093697_720w.png)

几轮之后，分组不再变化了，就可以停止了

![img](机器学习基础知识总结/v2-581fb188b4a38c52f26c12accc6b8108_720w.png)
...
![img](机器学习基础知识总结/v2-73f4f5b1c23dfba2f01a75c391f2bc67_720w.png)



`adaboost` 的栗子，手写识别中，在画板上可以抓取到很多 features，例如 始点的方向，始点和终点的距离等等

![img](机器学习基础知识总结/v2-5e509c77268f8d6e62bf28321e402e69_720w.png)
...
![img](机器学习基础知识总结/v2-ce3cf543b0d5183faaeeb0ebfbe05d41_720w.png)
...
![img](机器学习基础知识总结/v2-923e30794a0d21875539febeae7ae010_720w.png)
...
![img](机器学习基础知识总结/v2-bddecbdcfdf628f28cde834c1848e000_720w.png)
