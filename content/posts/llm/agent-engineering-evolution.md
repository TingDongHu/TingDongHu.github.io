---
title: "【LLM应用开发原理】从提示词工程、上下文工程到Harness工程的设计哲学"
...
![Agent工程化三阶段演进时间线](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/agent/agent-engineering-evolution-from-prompt-to-harness-philosophy/01-timeline-agent-evolution.png)
...
![提示词工程核心方法论架构图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/agent/agent-engineering-evolution-from-prompt-to-harness-philosophy/02-framework-prompt-engineering.png)
...
![上下文工程(RAG)技术栈分层架构图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/agent/agent-engineering-evolution-from-prompt-to-harness-philosophy/03-framework-context-engineering.png)
...
Harness工程的出现就是为了系统性解决这些生产级问题，它的设计哲学是**把传统软件工程的DevOps(自动化运维)理念完整移植到Agent开发领域，构建一整套覆盖Agent全生命周期的工程化体系**。
...
![Harness工程六大核心能力矩阵图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/agent/agent-engineering-evolution-from-prompt-to-harness-philosophy/04-framework-harness-engineering.png)
...
![Agent工程化三阶段演进对比信息图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/agent/agent-engineering-evolution-from-prompt-to-harness-philosophy/05-infographic-evolution-comparison.png)
