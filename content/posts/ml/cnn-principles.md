...
连续形式：
![在这里插入图片描述](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/9c2f215a5a4e799b471a83ecbc95044e.jpeg)
离散形式：
![在这里插入图片描述](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/237b89f84f60bc0183a2cde78336a38f.jpeg)
...
![图片灰度图数值](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/image-20250425115142334.png)
![图片灰度图](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/image-20250425115157590.png)
...
![三种通道](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/3ee4d843020005e6c6eca4a7fa1ae539.png)

### 为什么要学习卷积神经网络？
在传统神经网络中，我们要识别下图红色框中的图像时，我们很可能识别不出来，因为这六张图中同一形状的位置都不通，计算机无法分辨出他们其实是一种形状或物体。

![相对空间特征](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/4328b16077353c4f549246917d140cac.png)
 传统神经网络原理如下图：
![img](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/8cbc62e0ef1552e85c47a13cbbe57f08.png)
我们希望一个物体不管在画面左侧还是右侧，都会被识别为同一物体，这一特点就是不变性。为了实现平移不变性，卷积神经网络（CNN)等深度学习模型在卷积层中使用了卷积操作，这个操作可以捕捉到图像中的局部特征而不受其位置的影响。

![平移不变性](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/6e3f9cbdf2b3caa4ca3e9b2ade9856bf.png)
### 图片的卷积是怎样计算的？
...
![卷积形状变换](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/7e9292ea51a94bae998fc2a3239eedfc.png)
...
### 卷积神经网络的模型是什么样的？
![卷积过程](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/d0172774f7e42ae2f6310b63e59b4906.gif)
上面红框框起来的部分便可以理解为一个滤波器，即带着一组固定权重的神经元。多个滤波器叠加便成了卷积层。

### 卷积神经网络的构造
![卷积神经网络的构造](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/3c266da23107494b04b09683b8427f0e.png)
...
![图片展开味序列数据](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/487282ce8ead390f92a390a1471bb65b.gif)

图片卷积后的样子

![特征提取](https://pub-500a3a9e99b44ef29efa70fd87011d69.r2.dev/机器学习/深度学习卷积神经网络cnn的详细原理/34501738b7bedc58964269aef8305ee3.png)