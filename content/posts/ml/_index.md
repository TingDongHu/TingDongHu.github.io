---
title: 机器学习
description: 机器学习与深度学习基础知识笔记
---

## 机器学习基础
- [基础知识总结](machine-learning-basics/) — 机器学习核心概念与分类
- [梯度下降与损失函数](gradient-descent-loss/) — 优化算法与损失函数
...
- [ViewDiff 论文阅读](comfyui-viewdiff-paper/) — 基于文生图的 3D 一致图像生成
