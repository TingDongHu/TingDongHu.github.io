...
![从工具到技能的进化](illustrations/llm-agentskill-principle/01-infographic-tool-to-skill-evolution.png)
...
![渐进式披露的核心概念](illustrations/llm-agentskill-principle/02-infographic-progressive-disclosure.png)
...
![渐进式披露的三种实现范式](illustrations/llm-agentskill-principle/03-flowchart-progressive-disclosure-paradigms.png)
...
![Skill类型层级体系](illustrations/llm-agentskill-principle/04-framework-skill-types-hierarchy.png)
...
![Skill执行范式对比](illustrations/llm-agentskill-principle/05-flowchart-skill-execution-paradigms.png)
...
![Skill Registry架构](illustrations/llm-agentskill-principle/06-framework-skill-registry-architecture.png)
...
![Skill与Agent的三种集成方式对比](illustrations/llm-agentskill-principle/07-comparison-agent-integration-modes.png)
...
![Skill与MCP的完整架构关系](illustrations/llm-agentskill-principle/08-framework-skill-mcp-architecture.png)
