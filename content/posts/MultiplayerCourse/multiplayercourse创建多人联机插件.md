...
![image-20250419144230516](multiplayercourse创建多人联机插件/image-20250419144230516.png)
...
![image-20250419145217432](multiplayercourse创建多人联机插件/image-20250419145217432.png)
...
![image-20250419163923540](multiplayercourse创建多人联机插件/image-20250419163923540.png)

将项目打包到`项目/Build/`目录下,再运行可发现，右下角弹出了Steam服务调用的提示，而游戏窗口中的Logger也显示在线子系统返回的服务名称为Steam，证明访问子系统成功。

![image-20250419172411913](multiplayercourse创建多人联机插件/image-20250419172411913.png)
...
![image-20250420102143176](multiplayercourse创建多人联机插件/image-20250420102143176.png)

在项目打包设置中将该地图添加到`PackageMapsList`

![image-20250420102214960](multiplayercourse创建多人联机插件/image-20250420102214960.png)
...
![image-20250419231115199](multiplayercourse创建多人联机插件/image-20250419231115199.png)
...
![image-20250420103710527](multiplayercourse创建多人联机插件/image-20250420103710527.png)

![image-20250419235936495](multiplayercourse创建多人联机插件/image-20250419235936495.png)

![image-20250420103500768](multiplayercourse创建多人联机插件/image-20250420103500768.png)

## 创建插件

`new`一个`Blank`模板的`Plugin`，将其命名为`MultiplayerSessions`，在内容浏览界面打开`Show Plugin Content`

![image-20250420113012031](multiplayercourse创建多人联机插件/image-20250420113012031.png)

进入VS界面`ReloadAll`重新加载全部，查看插件模块，`Ctrl+Shift+B`编译

![image-20250420113226169](multiplayercourse创建多人联机插件/image-20250420113226169.png)
...
![image-20250420120249326](multiplayercourse创建多人联机插件/image-20250420120249326.png)
...
![image-20250420191931720](multiplayercourse创建多人联机插件/image-20250420191931720.png)

将用户控件添加到视口便于测试:

![image-20250420192245983](multiplayercourse创建多人联机插件/image-20250420192245983.png)
...
![image-20250421161705684](multiplayercourse创建多人联机插件/image-20250421161705684.png)
...
![image-20250422231114323](multiplayercourse创建多人联机插件/image-20250422231114323.png)

在之前写的`WBP_Menu`中添加一个退出按钮,由于此处逻辑过于简单了,直接写在蓝图中即可:

![image-20250422230932498](multiplayercourse创建多人联机插件/image-20250422230932498.png)