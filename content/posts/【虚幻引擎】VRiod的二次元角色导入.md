...
![image-20250424222850712](【虚幻引擎】VRiod的二次元角色导入/image-20250424222850712.png)

调整为自己心仪的模样后点击右上角导出为`VRM`文件.

![image-20250424223042603](【虚幻引擎】VRiod的二次元角色导入/image-20250424223042603.png)

不进行骨骼贴图调整,直接使用默认选项导出:

![image-20250424223201161](【虚幻引擎】VRiod的二次元角色导入/image-20250424223201161.png)
...
![image-20250424223907223](【虚幻引擎】VRiod的二次元角色导入/image-20250424223907223.png)

用虚幻引擎打开项目,在项目-设置-插件中开启该插件,重启项目.

![image-20250424225055135](【虚幻引擎】VRiod的二次元角色导入/image-20250424225055135.png)

之后就可以将之前制作好的VRM文件导入了(直接拖到某一文件夹下就行).需要注意的是在导入的时候要将高级选项-`Generate IK bone`勾选上:

![image-20250424225515367](【虚幻引擎】VRiod的二次元角色导入/image-20250424225515367.png)
...
![image-20250424234857831](【虚幻引擎】VRiod的二次元角色导入/image-20250424234857831.png)
...
![image-20250424235303283](【虚幻引擎】VRiod的二次元角色导入/image-20250424235303283.png)
...
![image-20250424233609721](【虚幻引擎】VRiod的二次元角色导入/image-20250424233609721.png)
